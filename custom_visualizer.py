...
class Visualizer(imgui_window.ImguiWindow):
    def __init__(self, capture_dir=None, wPath = None):
        ...
        self.latent_widget.w_path = wPath
...
def main():
    ...
    viz = Visualizer(wPath=f'{current_directory}/customcheckpoint/0.pt')

    custom_pickle = f'{current_directory}/customcheckpoint/model_stylegan2_custom.pkl'
    viz.add_recent_pickle(custom_pickle)
    viz.load_pickle(custom_pickle)
